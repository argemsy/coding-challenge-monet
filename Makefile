...
shell: ## Open Django shell inside container
	docker compose exec $(SERVICE) python manage.py shell_plus || docker compose exec $(SERVICE) python manage.py shell
...
fmt-test: ## Auto-format tests locally (Ruff fix + Black + Isort)
